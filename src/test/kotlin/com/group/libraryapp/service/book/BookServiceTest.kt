...
class BookServiceTest @Autowired constructor(
    ...
    fun loanBookTest() {
        ...
        val savedUser = userRepository.save(User("jonny", null))
        val request = BookLoanRequest("jonny", "이상한 나라의 앨리스")
    ...
    fun returnBookTest() {
        ...
        val request = BookReturnRequest("jonny", "이상한 나라의 앨리스")
    ...
    @Test
    @DisplayName("첵 대여 권수를 정상 확인한다")
    fun countLoanedBookTest() {
        // given
        val savedUser = userRepository.save(User("jonnygim", null))
